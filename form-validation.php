...
if($_SESSION['captcha_img_string']['32a614f62de907137f2cdba18d4eaf9d9112c740'] != $_POST['captcha_input']){
	$captcha_element_id = 'cfgen-element-1-11'; // will be used in merge_post
	$captcha_elementlabel_id = 'cfgen-element-1-11-label'; // will be used in element_ids_values
	$json_error_array['cfgen-element-1-11']['errormessage'] = $contactform_obj->cfg['form_errormessage_captcha'];
	$error_captcha = true;
}
